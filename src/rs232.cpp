...
int SerialConnect::OpenComport(int comport_number, int baudrate)
{
  int baudr;
  ...
  handle = Cport[comport_number];
  return(0);
}   //END OPENCOMPORT


int SerialConnect::PollComport(int comport_number, unsigned char *buf, int size)
{
  int n;
...
int SerialConnect::SendByte(int comport_number, unsigned char byte)
{
  int n;
...
int SerialConnect::SendBuf(int comport_number, unsigned char *buf, int size)
{
...
int SerialConnect::IsCTSEnabled(int comport_number)
{
  int status;
...
void SerialConnect::cprintf(int comport_number, const char *text)  /* sends a string to serial port */
{
